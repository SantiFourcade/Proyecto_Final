...
{
  hcan.Instance = CAN1;     
  hcan.Init.Prescaler = 8;      // 32MHz / 4 = 8MHz quanta clock
...
printf("Iniciando secuencia de despertar CAN...\r\n");
  ...
  // Esta función llama internamente a HAL_CAN_MspInit (donde se prenden relojes y pines)
  // ANTES de intentar tocar los registros MCR/MSR.
  else {
